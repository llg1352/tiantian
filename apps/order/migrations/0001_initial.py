# Generated by Django 3.0.8 on 2020-07-19 06:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.SmallIntegerField(choices=[(1, '待支付'), (2, '代发货'), (3, '待收货'), (4, '待评价'), (5, '已完成')], default=1, verbose_name='商品库存')),
                ('trade_no', models.CharField(max_length=128, verbose_name='支付id')),
            ],
            options={
